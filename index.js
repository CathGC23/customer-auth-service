...
const DB_CONFIG = {
    ...
    database: process.env.MYSQLDATABASE || "customer_auth_db",
    port: process.env.MYSQLPORT, // ⬅️ Added port variable
};
...
// ──────────────────────────────────────────────────
// Endpoint to get Customer Name and Email for Order Service (THE FIX)
// ──────────────────────────────────────────────────
...
// Start Server
// --------------------------------------------------
const PORT = process.env.PORT || 5004; // ⬅️ Using env.PORT
app.listen(PORT, () => {
